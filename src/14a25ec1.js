...
(function (root) {
     ...
     *
     **********************************************************/
    var BitView = function BitView(source, byteOffset, byteLength) {
     ...
     *
     **********************************************************/
    var reader = function reader(name, size) {
        return function () {
    ...
    var writer = function writer(name, size) {
    ...
    var BitStream = function BitStream(source, byteOffset, byteLength) {
        var isBuffer = source instanceof ArrayBuffer || typeof Buffer !== 'undefined' && source instanceof Buffer;
