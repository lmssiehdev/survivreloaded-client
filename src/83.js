...
/**
 * poisonEffect.js
 * This class represents the poison status effect of the game
 */
...
var PoisonEffect = function () {
    /**
     * Constructor
     * @param {boolean} runningOnClient Indicates if the effect will run on the client or the server 
     */
    function PoisonEffect(runningOnClient, params) {
        _classCallCheck(this, PoisonEffect);

        this.id = 11;
        this.name = "m_poisonEffect";
        ...
        this.type = StatusEffectAttackType.Poison;
    ...
    _createClass(PoisonEffect, [{
        ...
        value: function update(player, dt, damageList) {
            ...
            if (!this.runningOnClient) {
                damageList.addHit({
                    damageType: GameConfig.DamageType.Poison,
