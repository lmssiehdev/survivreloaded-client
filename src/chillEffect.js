...
var chillEffect = function () {
     ...
     */
    function chillEffect(runningOnClient, params) {
        _classCallCheck(this, chillEffect);

        this.id = 7;
        this.name = "m_chillEffect";
        ...
        this.type = StatusEffectAttackType.Chill;
    ...
    _createClass(chillEffect, [{
        ...
        value: function start(player, particleBarn) {
            if (this.runningOnClient) {
                ...
                player.addStatusSpeedPercentage(-(this.effectData.speedPercentage / 100));
            }
        ...
        value: function update(player, dt, damageList) {
            ...
            if (!this.runningOnClient) {
                //TODO reduce maxHealth
                if (this.ticker <= 0) {
                    //TODO increase maxHealth
                    // player.updateHealthByStatusEffect(this.effectData.points);
                    player.addStatusSpeedPercentage(this.effectData.speedPercentage / 100);
                }
